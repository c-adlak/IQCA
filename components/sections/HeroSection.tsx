      ...
      <div className="container mx-auto px-4 relative">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            >
              Transform your career with our CPD-accredited courses in Finance,
              Health & Safety, and Environmental Safety. Expert-led training
          ...
          <div
            className="md:w-1/2 relative animate-float"
            data-aos="fade-left"
            data-aos-duration="1000"
          >
