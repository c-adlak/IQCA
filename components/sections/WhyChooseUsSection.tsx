...
import { BadgeCheck, UserCheck, BookOpen, Headset } from "lucide-react";
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12" data-aos="fade-up">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">
            Why Choose IQCA Board?
          </h2>
          <p className="text-lg text-gray-700 max-w-2xl mx-auto">
            Your Trusted Training Partner for Professional Development and
            Certification
          </p>
        </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Our CPD-accredited courses are recognized by leading
                      employers worldwide, enhancing your professional
                      credibility.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 feature-card transition-all duration-300">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Learn from industry veterans with extensive practical
                      experience who bring real-world insights to every course.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 feature-card transition-all duration-300">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Our courses blend theoretical knowledge with practical
                      applications, ensuring you can immediately apply what you
                      learn.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 feature-card transition-all duration-300">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Our support team is available to assist you throughout
