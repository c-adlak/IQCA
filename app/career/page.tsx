...
import { Briefcase, FileText, User, Mail, Send } from "lucide-react";
...
const CareerPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setForm({ name: "", email: "", position: "", resume: null, message: "" });
    } catch (err: any) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="relative md:col-span-2">
              ...
              <input
                ...
                onChange={handleChange}
                required
                className="w-full border-2 border-blue-100 rounded-lg px-4 py-2 bg-blue-50/50 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-100 file:text-blue-900 hover:file:bg-blue-200"
              />
            </div>
            <div className="relative md:col-span-2">
              <label className="text-gray-700 mb-1 font-semibold flex items-center gap-2">
